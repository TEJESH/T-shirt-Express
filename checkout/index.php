...
<div id="page">
  ...
  <div id="content-register">
	...
	<form id="checkout" name="checkout" action="checkout.php"  method="post">
	  ...
	  <input type="email" name="email" id="email" class="txtfield" tabindex="20" autocomplete="off">
 
	  <label for="address">Shipping Address</label>
	  <input type="text" name="address" id="address" class="txtfield" tabindex="100" autocomplete="off">
 
<label for="city">City</label>
	  <input type="text" name="city" id="city" class="txtfield" tabindex="100" autocomplete="off">

<label for="zip">Zip-Code</label>
	  <input type="text" name="zip" id="zip" class="txtfield" tabindex="100" autocomplete="off">

<label for="state">State</label>
	  <input type="text" name="state" id="state" class="txtfield" tabindex="100" autocomplete="off">
	  ...
	  <input type="submit" name="registerbtn" id="registerbtn" value="Finish" class="btn" tabindex="9">
</form>
	</div>
